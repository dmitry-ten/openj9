   ...
   if (TR::Options::getVerboseOption(TR_VerboseJITaaS))
      {
         ...
         TR_VerboseLog::writeLineLocked(TR_Vlog_JITaaS,"Message received by client %s(%d) while compiling %s on compThread = %d",
                                        descriptor->FindValueByNumber(response)->name().c_str(),
                                        response,
                                        comp->signature(),
