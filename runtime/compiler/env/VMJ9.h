...
/////
   ...
   */
    ...
    */
   virtual TR_ResolvedMethod* targetResolvedMethodFromInvokeCacheArray(TR::Compilation *comp, TR_ResolvedMethod *owningMethod, uintptr_t *invokeCacheArray);
    ...
    *    Encapsulates code that requires VM access to make JITServer support easier.
    */
   virtual TR::KnownObjectTable::Index getKnotIndexOfInvokeCacheArrayAppendixIndex(TR::Compilation *comp, uintptr_t *invokeCacheArray);

   /*
    * \brief
    *    Wrapper for J9::SymbolReferenceTable::refineInvokeCacheElementSymRefWithKnownObjectIndex.
    *    Encapsulates code that requires VM access to make JITServer support easier.
    */
