...
protected:
   ...
   virtual char *                fieldOrStaticNameChars(int32_t cpIndex, int32_t & len) override;
   void setAttributeResult(bool isStaticField, bool result, UDATA ltype, I_32 myVolatile, I_32 myFinal, I_32 myPrivate, TR::DataType * type, bool * volatileP, bool * isFinal, bool * isPrivate, void ** fieldOffset);
